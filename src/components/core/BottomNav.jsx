...
const TriangleShape = styled.div`
  ...
  border-bottom: 10vh solid
    ${(props) => (props.$isWhite ? "white" : "transparent")};
  position: relative;
    ...
    >
      {isMobile ? (
        <div className="flex justify-center items-center text-base text-bold font-bold">
          ...
          <div className="h-8 uppercase text-lg mb-2 whitespace-nowrap leading-8">
            Scroll to {!isLast ? "next" : "last"} page
          </div>
          {!isLast && (
            <div className="w-12 h-8 mb-2 py-1 scale-90">
              <img
                src={ArrowIcon}
                alt="Arrow Icon"
                className="w-full h-full ml-2"
        ...
        >
          <div className="items-center text-bold 2xl:text-black font-bold mt-20 2xl:mt-28 hidden sm:flex">
            ...
            <div className="h-8 uppercase text-2xl mb-2 whitespace-nowrap leading-8">
              Scroll to {!isLast ? "next" : "last"} page
            </div>
            {!isLast && (
